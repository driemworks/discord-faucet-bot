...
describe('Etf', () => {
    ...
    it('should initialize correctly', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield etf.init(JSON.stringify(chainSpec));
        expect(createSpy).toHaveBeenCalledWith(expect.objectContaining({
            provider: expect.anything(),
        }));
        createSpy.mockRestore();
    }));
    it('should initialize correctly with light client', () => __awaiter(void 0, void 0, void 0, function* () {
        const createSpy = jest.spyOn(ApiPromise, 'create');
        const etf = new Etf();
        yield etf.init(JSON.stringify(chainSpec));
        expect(createSpy).toHaveBeenCalledWith(expect.objectContaining({
    ...
    it('should encrypt a message', () => __awaiter(void 0, void 0, void 0, function* () {
        const etf = new Etf();
        yield etf.init(JSON.stringify(chainSpec));
        const nextSlot = {
            slot: '123,456,789',
    ...
    it('should fail to encrypt a message with an empty slot schedule', () => __awaiter(void 0, void 0, void 0, function* () {
        const etf = new Etf();
        yield etf.init(JSON.stringify(chainSpec));
        const nextSlot = {
            slot: '123,456,789',
    ...
    it('should decrypt a message', () => __awaiter(void 0, void 0, void 0, function* () {
        const etf = new Etf();
        yield etf.init(JSON.stringify(chainSpec));
        const nextSlot = {
            slot: '123,456,789',
        ...
        const result = yield etf.decrypt(ct, nonce, capsule, [1, 3, 5]);
