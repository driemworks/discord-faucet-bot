...
function start(options, wasmModule, platformBindings) {
    ...
    return {
        addChain: (options) => __awaiter(this, void 0, void 0, function* () {
            ...
            state.instance.instance.addChain(options.chainSpec, typeof options.databaseContent === 'string' ? options.databaseContent : "", potentialRelayChainsIds, !!options.disableJsonRpc);
