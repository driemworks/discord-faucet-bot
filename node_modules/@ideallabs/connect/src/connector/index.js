...
var smoldot_light_js_1 = require("./smoldot-light.js");
var extension_js_1 = require("./extension.js");
var connect_extension_protocol_1 = require("@substrate/connect-extension-protocol");
...
function createScClient(config) {
    var forceEmbedded = config === null || config === void 0 ? void 0 : config.forceEmbeddedNode;
